...
const NIT: usize = %% NIT %%; // for class S
const NX_DEFAULT: usize = %% PROBLEM_SIZE %%;
const NY_DEFAULT: usize = %% PROBLEM_SIZE %%;
const NZ_DEFAULT: usize = %% PROBLEM_SIZE %%;
const NIT_DEFAULT: usize = NIT;
const LM: usize = ilog2(%% PROBLEM_SIZE %%) as usize;
const LT_DEFAULT: usize = LM;
const DEBUG_DEFAULT:usize = 0;
const NDIM1: usize = LM;
const NDIM2: usize = ilog2(%% PROBLEM_SIZE %%) as usize;
const NDIM3: usize = ilog2(%% PROBLEM_SIZE %%) as usize;
const ONE: usize = 1;
